...
-- Dumping structure for table jade_chars.account_data
...
-- Dumping structure for table jade_chars.account_instance_times
...
-- Dumping structure for table jade_chars.account_tutorial
...
-- Dumping structure for table jade_chars.addons
...
-- Dumping structure for table jade_chars.arena_team
...
-- Dumping structure for table jade_chars.arena_team_member
...
-- Dumping structure for table jade_chars.auctionhouse
...
-- Dumping structure for table jade_chars.bugreport
...
-- Dumping structure for table jade_chars.calendar_events
...
-- Dumping structure for table jade_chars.calendar_invites
...
-- Dumping structure for table jade_chars.channels
...
-- Dumping structure for table jade_chars.characters
...
-- Dumping structure for table jade_chars.characters_back
DROP TABLE IF EXISTS `characters_back`;
CREATE TABLE IF NOT EXISTS `characters_back` (
  `guid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Global Unique Identifier',
  `account` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Account Identifier',
  `name` varchar(12) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `slot` tinyint(3) unsigned NOT NULL DEFAULT '0',
...
-- Dumping structure for table jade_chars.character_account_data
...
-- Dumping structure for table jade_chars.character_achievement
...
-- Dumping structure for table jade_chars.character_achievement_progress
...
-- Dumping structure for table jade_chars.character_action
...
-- Dumping structure for table jade_chars.character_arena_stats
...
-- Dumping structure for table jade_chars.character_aura
...
-- Dumping structure for table jade_chars.character_banned
...
-- Dumping structure for table jade_chars.character_battleground_data
...
-- Dumping structure for table jade_chars.character_battleground_random
...
-- Dumping structure for table jade_chars.character_cuf_profiles
...
-- Dumping structure for table jade_chars.character_currency
...
-- Dumping structure for table jade_chars.character_declinedname
...
-- Dumping structure for table jade_chars.character_equipmentsets
...
-- Dumping structure for table jade_chars.character_gifts
...
-- Dumping structure for table jade_chars.character_glyphs
...
-- Dumping structure for table jade_chars.character_homebind
...
-- Dumping structure for table jade_chars.character_instance
...
-- Dumping structure for table jade_chars.character_inventory
...
-- Dumping structure for table jade_chars.character_pet
...
-- Dumping structure for table jade_chars.character_pet_declinedname
...
-- Dumping structure for table jade_chars.character_queststatus
...
-- Dumping structure for table jade_chars.character_queststatus_daily
...
-- Dumping structure for table jade_chars.character_queststatus_monthly
...
-- Dumping structure for table jade_chars.character_queststatus_rewarded
...
-- Dumping structure for table jade_chars.character_queststatus_seasonal
...
-- Dumping structure for table jade_chars.character_queststatus_weekly
...
-- Dumping structure for table jade_chars.character_reputation
...
-- Dumping structure for table jade_chars.character_skills
...
-- Dumping structure for table jade_chars.character_social
...
-- Dumping structure for table jade_chars.character_spell
...
-- Dumping structure for table jade_chars.character_spell_cooldown
...
-- Dumping structure for table jade_chars.character_stats
...
-- Dumping structure for table jade_chars.character_talent
...
-- Dumping structure for table jade_chars.character_void_storage
...
-- Dumping structure for table jade_chars.character_warn
DROP TABLE IF EXISTS `character_warn`;
CREATE TABLE IF NOT EXISTS `character_warn` (
...
-- Dumping structure for table jade_chars.corpse
...
-- Dumping structure for table jade_chars.creature_respawn
...
-- Dumping structure for table jade_chars.gameobject_respawn
...
-- Dumping structure for table jade_chars.game_event_condition_save
...
-- Dumping structure for table jade_chars.game_event_save
...
-- Dumping structure for table jade_chars.gm_subsurveys
...
-- Dumping structure for table jade_chars.gm_surveys
...
-- Dumping structure for table jade_chars.gm_tickets
...
-- Dumping structure for table jade_chars.groups
...
-- Dumping structure for table jade_chars.group_instance
...
-- Dumping structure for table jade_chars.group_member
...
-- Dumping structure for table jade_chars.guild
...
-- Dumping structure for table jade_chars.guild_achievement
...
-- Dumping structure for table jade_chars.guild_achievement_progress
...
-- Dumping structure for table jade_chars.guild_bank_eventlog
...
-- Dumping structure for table jade_chars.guild_bank_item
...
-- Dumping structure for table jade_chars.guild_bank_right
...
-- Dumping structure for table jade_chars.guild_bank_tab
...
-- Dumping structure for table jade_chars.guild_eventlog
...
-- Dumping structure for table jade_chars.guild_finder_applicant
...
-- Dumping structure for table jade_chars.guild_finder_guild_settings
...
-- Dumping structure for table jade_chars.guild_member
...
-- Dumping structure for table jade_chars.guild_member_withdraw
...
-- Dumping structure for table jade_chars.guild_newslog
...
-- Dumping structure for table jade_chars.guild_rank
...
-- Dumping structure for table jade_chars.instance
...
-- Dumping structure for table jade_chars.instance_reset
...
-- Dumping structure for table jade_chars.item_instance
...
-- Dumping structure for table jade_chars.item_loot_items
...
-- Dumping structure for table jade_chars.item_loot_money
...
-- Dumping structure for table jade_chars.item_refund_instance
...
-- Dumping structure for table jade_chars.item_soulbound_trade_data
...
-- Dumping structure for table jade_chars.lag_reports
...
-- Dumping structure for table jade_chars.lfg_data
...
-- Dumping structure for table jade_chars.mail
...
-- Dumping structure for table jade_chars.mail_items
...
-- Dumping structure for table jade_chars.petition
...
-- Dumping structure for table jade_chars.petition_sign
...
-- Dumping structure for table jade_chars.pet_aura
...
-- Dumping structure for table jade_chars.pet_spell
...
-- Dumping structure for table jade_chars.pet_spell_cooldown
...
-- Dumping structure for table jade_chars.pool_quest_save
...
-- Dumping structure for table jade_chars.reserved_name
...
-- Dumping structure for table jade_chars.warden_action
...
-- Dumping structure for table jade_chars.worldstates
