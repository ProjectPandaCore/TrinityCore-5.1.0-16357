...
class WorldSession
{
    public:
        ...
        // Pet
        void SendPetNameQuery(uint64 guid, uint64 petnumber);
    ...
    public:                                                 // opcodes handlers
        ...
        void HandleRaidRedyCheckResponse(WorldPacket& recvData);
        ...
        void HandleDbQueryOpcode(WorldPacket& recvPacket);
		...
		void HandleDuelRequest(WorldPacket& recvPacket);
        ...
        void HandleSetSpecializationOpcode(WorldPacket& recvPacket);
